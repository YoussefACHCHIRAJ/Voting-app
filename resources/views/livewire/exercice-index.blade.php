<div x-data
    @click="
                    ...
                    if( mustClicked )
                        $event.target.closest('.exercice-container').querySelector('.exercice-link').click()
                "
    class="exercice-container hover:shadow-card cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
