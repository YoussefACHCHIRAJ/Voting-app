<form wire:submit.prevent="createExercice" action="#" method="POST" class="space-y-4 px-4 py-6">
    <div>
    ...
    <div>
        <select wire:model.defer="language" name="language_add" id="language_add" class="w-full bg-gray-100 text-sm rounded-xl px-4 py-2 border-none">
