        ...
        <div class="flex flex-col md:flex-row items-center gap-x-4 ml-6">
            ...
            <div class="relative" x-data="{isOpen: false}">
                <button type="button" @click="isOpen = !isOpen"
                    class="mt-3 md:mt-0 flex items-center justify-center w-full md:w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border borde-gray-100 hover:border-gray-400 transition duration-150 px-6 py-3 ease-in">
                ...
                <div x-show="isOpen"  x-cloak @click.away="isOpen = false" class="absolute z-10 w-64 md:w-76 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
