<x-app-layout>
        ...
        <div class="flex flex-1 px-4 py-6">
            ...
            <div class="mx-4  w-full">
                ...
                <div class="text-gray-600 mt-3">
                    ...
                    adipisicing elit. Maiores, corporis! Aliquid, fugit ullam incidunt ratione assumenda delectus
                    corrupti placeat nostrum. Excepturi perferendis ut minus fugiat! Accusamus quae officia assumenda?
                    Soluta!
                </div>
    ...
    <div class="flex items-center justify-between mt-6">
        <div class="flex items-center gap-x-4 ml-6">
            <div class="relative">
                <button type="submit"
                    class="w-32 h-11 text-sm text-white bg-blue font-semibold rounded-xl border bordeblue hover:bg-blue-hover transition duration-150 px-6 py-3 ease-in">
            ...
            <div class="relative">
                <button type="button"
                    class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold rounded-xl border borde-gray-100 hover:border-gray-400 transition duration-150 px-6 py-3 ease-in">
                    ...
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" checked="" class="bg-gray-200 text-black border-none"
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    ...
                                    <span class="ml-2">In considering</span>
                                </label>
                            </div>
                            <div>
                                <label class="inline-flex items-center">
                            ...
                            <div>
                                <label class="inline-flex items-center">
                                    <input type="radio" class=" bg-gray-200 text-red border-none"
                                        name="radio-direct" value="3">
                        ...
                        <div>
                            <textarea name="update_comment" id="update_comment" cols="30" rows="3"
                                class="w-full text-sm bg-gray-100 rounded-xl border-none px-4 py-2 placeholder:text-gray-900"
                                placeholder="Add an update comment (optionnel)"></textarea>
                            </div>
                            <div class="flex items-center gap-3">
                                <button type="button"
                                    class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200 font-semibold rounded-xl border borde-gray-100 hover:border-gray-400 transition duration-150 px-6 py-3 ease-in">
